...
export const dictionaries = {
  fr: {
    ...
    checkoutSubtitle: "Livraison à domicile (Rimouski) \u2014 carte en ligne ou paiement local selon le compte.",
  ...
  en: {
    ...
    checkoutSubtitle: "Home delivery (Rimouski) \u2014 online card payment or local payment depending on the account.",
