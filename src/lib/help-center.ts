...
export function getHelpCenterQuestions(language: Language, business: BusinessInfo): HelpQuestion[] {
  if (language === "fr") {
    return [
      ...
      {
        q: "O\u00f9 livrez-vous ?",
        a: "Chez Olive dessert surtout Rimouski et les environs. Le checkout confirme si l\u2019adresse entre bien dans notre zone locale.",
      },
      {
        q: "Quels modes de paiement sont accept\u00e9s ?",
        a: "Selon la commande, le paiement peut se faire avec Stripe ou en mode manuel. Le mode disponible est toujours affich\u00e9 clairement au checkout.",
      },
      {
        q: "O\u00f9 voir les frais, les taxes et le total ?",
        a: "Le checkout affiche le sous-total, la livraison, le total avant taxes, la TPS, la TVQ et le total final avant de confirmer la commande.",
      },
      {
    ...
    return [
      {
        ...
        body: "La livraison est offerte surtout \u00e0 Rimouski et dans les environs. L\u2019adresse est valid\u00e9e au checkout pour confirmer si elle fait partie de la zone locale desservie.",
      },
      {
      ...
      },
      {
        ...
        body: "Le checkout affiche toujours les frais de livraison, les taxes et le total final avant la confirmation. Tu peux donc valider clairement le montant \u00e0 payer.",
      },
      {
        title: "Besoin d\u2019aide ?",
  ...
  if (language === "fr") {
    return [
      ...
      },
      {
        ...
        body: "Les commandes sont soumises \u00e0 la disponibilit\u00e9 des produits. Le mode de paiement offert est affich\u00e9 au checkout avant la confirmation.",
      },
      {
