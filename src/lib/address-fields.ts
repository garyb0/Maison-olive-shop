...
export const CANADIAN_PROVINCE_OPTIONS: AddressSelectOption[] = [
  ...
  { value: "NS", labelFr: "Nouvelle-Ecosse", labelEn: "Nova Scotia" },
  ...
  { value: "PE", labelFr: "Ile-du-Prince-Edouard", labelEn: "Prince Edward Island" },
  { value: "QC", labelFr: "Quebec", labelEn: "Quebec" },
