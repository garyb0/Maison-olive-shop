        ...
        <section className="site-footer">
          <div className="site-footer__brand">
            ...
            <h2 className="site-footer__title">
              {language === "fr"
                ? "Une boutique locale pensée pour les humains et leurs compagnons."
                : "A local shop designed for humans and their companions."}
            </h2>
            <p className="site-footer__text">
              {language === "fr"
                ? "Commande, livraison, aide et suivi dans une expérience simple, chaleureuse et cohérente."
                : "Order, delivery, support, and follow-up in one simple, warm, and consistent experience."}
            </p>
          </div>
