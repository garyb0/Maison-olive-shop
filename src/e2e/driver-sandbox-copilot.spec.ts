...
const screenshotDir = path.join(process.cwd(), "test-results", "delivery-driver-copilot");
...
test("recette visuelle du copilote livreur sandbox", async ({ context, page }, testInfo) => {
    ...
    Object.defineProperty(navigator, "geolocation", {
      ...
      value: {
        ...
        watchPosition(success: PositionCallback) {
          return window.setTimeout(() => success(buildPosition()), 25);
        },
