  ...
  return (
    <section className="section">
      ...
      <p className="small" style={{ marginBottom: 24 }}>
        {language === "fr" ? "Besoin d'aide ? Nous sommes là pour toi." : "Need help? We're here for you."}
      </p>

      <div className="card" style={{ maxWidth: 600, padding: 24, textAlign: 'center' }}>
        <div style={{ fontSize: "3rem", marginBottom: 16 }}>💬</div>
        <h3>{language === "fr" ? "Contactez-nous" : "Contact us"}</h3>
        <p className="small" style={{ marginBottom: 24 }}>
          {language === "fr" 
            ? "Tu peux nous joindre par email à l'adresse support@chezolive.ca" 
            : "You can reach us by email at support@chezolive.ca"}
        </p>
        <a className="btn" href="mailto:support@chezolive.ca">
