        ...
        <div className="card" style={{ padding: 18, marginBottom: 24 }}>
          {paymentNotice === "paid" ? (
            <p style={{ margin: 0, color: "var(--success)" }}>
              {language === "fr"
                ? "Paiement Stripe reçu. Ta commande est maintenant confirmée."
          ...
          {paymentNotice === "syncing" ? (
            <p style={{ margin: 0 }}>
              {language === "fr"
                ? "Paiement reçu par Stripe. La confirmation finale peut prendre quelques secondes."
          ...
          {paymentNotice === "sync_failed" ? (
            <p style={{ margin: 0 }}>
              {language === "fr"
                ? "Paiement reçu par Stripe. Si ta commande n'apparaît pas encore payée, elle sera synchronisée par le webhook."
