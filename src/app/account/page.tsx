...
export default async function AccountDashboardPage({ searchParams }: AccountDashboardPageProps) {
  ...
  return (
    <>
      ...
      {paymentNotice ? (
        <div className={`account-notice account-notice--${paymentNotice}`}>
          {paymentNotice === "paid" ? (
            <p>
              {language === "fr"
      ...
      <section className="account-home-stats account-home-stats--dashboard">
      ...
      <section className="section account-section-card">
        <div className="account-section-head">
          <div>
            <p className="account-home-hero__eyebrow">{language === "fr" ? "Raccourcis" : "Shortcuts"}</p>
            <h2>{language === "fr" ? "Actions utiles" : "Useful actions"}</h2>
            <p className="small account-section-copy">
              {language === "fr"
