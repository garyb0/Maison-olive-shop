...
export function AdminDeliveryClient({ language, initialSlots, todayDeliveries = [] }: Props) {
  ...
  const formatSlotOptionLabel = (slot: DeliverySlotRow) => {
    ...
    return `${formatDateTime(slot.startAt)} -> ${formatDateTime(slot.endAt)} (${availabilityLabel})`;
  };
                      ...
                      <td>
                         <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                           ...
                           <div style={{ 
                             ...
                             <div style={{
                               height: "100%",
                               width: `${Math.min(100, (slot.reservedCount / slot.capacity) * 100)}%`,
                               backgroundColor: 
                                 (slot.reservedCount / slot.capacity) >= 0.9 ? "#dc2626" :
                                 (slot.reservedCount / slot.capacity) >= 0.7 ? "#d97706" : "#16a34a"
                             }} />
                           </div>
                         </div>
                       </td>
